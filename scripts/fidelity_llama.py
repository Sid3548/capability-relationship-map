"""Fidelity check: int8 vs fp16 for LLaMA-3.1-8B on the coding battery.
fp16 run on CPU (16GB GPU can't hold 8B fp16) -- small subset only.
...
Usage: python -m scripts.fidelity_llama
"""
